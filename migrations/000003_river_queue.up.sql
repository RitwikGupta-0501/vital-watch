-- Migration 001: create river migration
...
-- Migration 003: river job tags non null
...
-- Migration 004: pending and more
...
-- Migration 005: migration unique client
--
...
-- Migration 007: notification outbox sqlite jsonb and sql cleanup
--
-- Notification outbox.
--
