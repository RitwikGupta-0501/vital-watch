...
func (q *Queries) CreatePatientProfile(ctx context.Context, arg CreatePatientProfileParams) error {
	_, err := q.db.ExecContext(ctx, createPatientProfile, arg.UserID, arg.FirstName, arg.LastName)
	return err
}
...
func (q *Queries) CreatePatientUser(ctx context.Context, arg CreatePatientUserParams) (uuid.UUID, error) {
	row := q.db.QueryRowContext(ctx, createPatientUser, arg.Email, arg.HashedPassword)
	var id uuid.UUID
	err := row.Scan(&id)
	return id, err
}
...
func (q *Queries) GetPatientsByDoctorID(ctx context.Context, arg GetPatientsByDoctorIDParams) ([]GetPatientsByDoctorIDRow, error) {
	rows, err := q.db.QueryContext(ctx, getPatientsByDoctorID, arg.DoctorID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
